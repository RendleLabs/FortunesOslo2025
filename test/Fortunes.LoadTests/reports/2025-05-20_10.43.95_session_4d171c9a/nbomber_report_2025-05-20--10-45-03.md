...
session id: `2025-05-20_10.43.95_session_4d171c9a`
...
|latency (ms)|min = `1.94`, mean = `14.88`, max = `300.71`, StdDev = `26.81`|
|latency percentile (ms)|p50 = `6.07`, p75 = `9.05`, p95 = `59.23`, p99 = `151.81`|
